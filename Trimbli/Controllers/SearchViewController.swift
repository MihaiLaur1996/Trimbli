...
//
//            if let url = url {
//                let metadataList = MediaPlayer.shared.fetchAssetsRemote(url: url)
...
//            MediaPlayer.songIndex = indexPath.row
//            MediaPlayer.chosenSong = MediaPlayer.shared.songs[indexPath.row].songID
//            MediaPlayer.shared.playRemote(songName: MediaPlayer.chosenSong)
//            readyForSegue(indexPath: indexPath)
//        } else if MediaPlayer.playing == true && MediaPlayer.chosenSong != MediaPlayer.shared.songs[indexPath.row].songID {
//            MediaPlayer.chosenSong = MediaPlayer.shared.songs[indexPath.row].songID
//            MediaPlayer.shared.playRemote(songName: MediaPlayer.chosenSong)
//            readyForSegue(indexPath: indexPath)
